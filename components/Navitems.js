...
function Navitems({name, counter, icon}) {
    ...
    return (
        <div  onClick={function() {
           }} className={`${counter < 0 ? 'bg-gray-50 text-[#198A00]' : 'bg-none text-white'} flex cursor-pointer p-2 items-center mb-2 rounded-xl transition duration-150 transform hover:bg-gray-50 hover:text-[#198A00] text-sm`}>
