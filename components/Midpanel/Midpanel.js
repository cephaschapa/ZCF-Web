...
function Midpanel() {
    ...
    return (
        <div className="w-1/3 bg-gray-100 h-screen pr-2 pt-0 p-0 text-white mr-1 overflow-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
            {/* Header */}
            <div className="bg-[#198A00] p-3 rounded-br-2xl rounded-bl-2xl top-0 sticky shadow-lg">
